...
CheckFile1.open("Seven_layer_surface_neutron_with_H.dat", std::ios::app);
CheckFile1 << TrackID << " " << PosX << " " << PosY << " " << PosZ << " " << KineticEnergy << " " << ParticleName << " " << Volume->GetName() << " " << ProcessName << G4endl;
CheckFile1.close();
}
}
}
if (Volume->GetName() == "Layer_I" || Volume->GetName() == "Layer_II" || Volume->GetName() == "Layer_III" || Volume->GetName() == "Layer_IV" || Volume->GetName() == "Layer_V" || Volume->GetName() == "Layer_VI" || Volume->GetName() == "Layer_VII"){
if (ParticleName == "neutron"){
if (ProcessName == "Transportation"){
std::ofstream CheckFile2;
CheckFile2.open("Moon_surface_neutron_voxel_with_H.dat", std::ios::app);
